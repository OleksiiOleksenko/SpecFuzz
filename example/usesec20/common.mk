...
SLH_COMMON := --whitelist $(CURDIR)/$(WHITELIST) --whitelist-loads $(CURDIR)/loadlist.txt --whitelist-files $(CURDIR)/perf_function_list.txt  --debug-pass
...
PATCH_COMMON := --lfence --whitelist $(CURDIR)/$(WHITELIST) --whitelist-files $(CURDIR)/perf_function_list.txt --debug-pass
