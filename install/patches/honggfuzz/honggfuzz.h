...
#define COVERAGE_INDEX_MASK ((1U << COVERAGE_INDEX_WIDTH) - 1)
...
/* Vulnerability map interface */
#define VULN_MAP_INDEX_WIDTH 16U
#define VULN_MAP_INDEX_OFFSET 5U
#define VULN_MAP_INDEX_MASK (((1U << VULN_MAP_INDEX_WIDTH) - 1) << VULN_MAP_INDEX_OFFSET)
